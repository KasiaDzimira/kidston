...
if(file_exists($year.'/'.$month.'/awstats.'.$domain.'.html')){
    ...
    while (!feof($handle)) {
        ...
        if(preg_match("/lang='fr'/", $contents)){
            $lang = 'fr';
            break;
        }
        else if(preg_match("/lang='de'/", $contents)){
            $lang = 'de';
            break;
        }
        else{
...
$txt[7]['fr'] = 'Qui:';
$txt[8]['fr'] = 'Pays';
$txt[9]['fr'] = 'Liste compl�te';
$txt[10]['fr'] = 'H�tes';
$txt[11]['fr'] = 'Liste compl�te';
$txt[12]['fr'] = 'Derni�re visite';
$txt[13]['fr'] = 'Adresses IP non r�solues';
$txt[14]['fr'] = 'Visiteurs Robots/Spiders';
$txt[15]['fr'] = 'Liste compl�te';
$txt[16]['fr'] = 'Derni�re visite';
...
$txt[13]['de'] = 'Unaufgel�ste IP Adressen';
...
$txt[18]['fr'] = 'Dur�e des visites';
$txt[19]['fr'] = 'Types de fichiers';
$txt[20]['fr'] = 'Pages vues';
$txt[21]['fr'] = 'Liste compl�te';
$txt[22]['fr'] = 'Entr�e';
$txt[23]['fr'] = 'Sortie';
$txt[24]['fr'] = 'Syst�mes exploitation';
$txt[25]['fr'] = 'Versions';
$txt[26]['fr'] = 'Inconnu';
...
$txt[33]['fr'] = 'Sites r�f�renceurs';
$txt[34]['fr'] = 'Recherche';
$txt[35]['fr'] = 'Phrases cl�s';
$txt[36]['fr'] = 'Mots cl�s';
...
$txt[33]['de'] = 'Websites';
$txt[34]['de'] = 'H�ufigkeit';
$txt[35]['de'] = 'Suchausdr�cke';
