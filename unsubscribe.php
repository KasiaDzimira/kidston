...
if($user_detail[0] == "JMA"){
    ...
    $aff_row =  $db->delete_sql("delete from job_master where ID='".$user_id."'");
}
if($user_detail[0] == "PMA"){
    ...
    $aff_row =  $db->delete_sql("delete from professional_master where ID='".$user_id."'");
                                                            ...
                                                            <div class="home-tab-sec">
                                                                <div class="home-tab-r1">
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="185" align="left" valign="middle"><span class="tab-menu-sel">Email - De-Activation</span></td>
                                                                            <td width="1"></td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                                        ...
                                                                        <div class="home-tab-txt">
                                                                            <div class="tab-text-content">
                                                                                <div class="inn-tab-text-cont-left-detail">
                                                                                    <div class="h1"><br />
                                                                                        Thanks,Your email-id {<?PHP echo $user_email;?>} has been deactivated.</div>
                                                                                    <br />
                                                                                    <br />
                                                                                    <table width="100%" border="0" cellpadding="3" cellspacing="2"><tr>
                                                                                            <td height="35"><span class="h3">You will not receive email notification for following</span></td></tr>
