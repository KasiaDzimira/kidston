...
echo "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>";	 		
		...
		$xm  = "<JOBS>";
			...
			{//for loop			
				...
				$sql_xml['job_title'];	
				$orgid = $sql_xml['job_business'];
				if(($orgid == "Admin./HR/Consulting/CEO") || ($orgid == "Finance/Trusts/Real estate") || ($orgid =="Banking/Insurance") || ($orgid == "Product/Purchasing/Forwarding") || ($orgid == "Sales/Customer service/Admin"))
				{
					$sqlorg = "41902";
				}
				if(($orgid == "Information technology/Telecom") || ($orgid == "Electronic/Mechanics/Engineering"))
				{
					$sqlorg = "3685";
				}	
				if($sql_xml >0)
