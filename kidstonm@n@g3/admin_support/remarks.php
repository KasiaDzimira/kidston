...
<?PHP
			$rremarks = $db->getTableArray("select al.remarks,al.application_status,DATE_FORMAT(al.auth_date,'%D %M, %Y') as dd,al.auth_by,aa.name from application_link al,admin_access aa where al.application_id='".$_REQUEST["id"]."' and al.auth_by = aa.ID");
