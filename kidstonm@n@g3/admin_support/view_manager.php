<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><strong>Manager Master List</strong></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
	...
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC"> 
  	<?PHP	
		...
		{ // msg
			...
			$sql_admin_type = $db->fetchSingleRow("select * from admin_type where type_name = 'Manager' ");
  ...
  <tr class="row" onmouseover="changeCSS(this,'#FBFBE7','#FCFAF3','#535353');this.style.cursor='pointer'" onmouseout="changeCSS(this,'#F9F9F9','#FCFAF3','#535353');">
	...
	<?PHP 
	  ...
	  ?>
	   ...
	   ?>   &nbsp; 
	<a href="home.php?src=add-manager&amp;act=edit&amp;id=<?PHP echo $rs_image[$i]['ID']; ?>&amp;page=<?PHP echo $_REQUEST['page']; ?>" class="red-link">E</a> 
	&nbsp;
