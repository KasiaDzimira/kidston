<?PHP
	...
	{	
	    ...
	    { //add resources menu  
	   ?> 
	  		<li><a href="<?PHP echo SITE_URL;?>view-intern.php">Intern Jobs</a></li>
		<?PHP  
		} //add resources menu   
		...
		<?PHP
				...
				{
		?>
 			<li><a href="<?PHP echo SITE_URL; ?>view-latest-openings.php">View latest Openings</a></li>
		<?PHP
				}
				if($get_mid == "4")
				{
		...
		?>
			<li><a href="<?PHP echo SITE_URL; ?>view_talent.php">Talents</a></li>
			<li><a href="<?PHP echo SITE_URL.$pval; ?>">Post a Job Ad</a></li>
		<?PHP
				}
		?>
			<li>
...
function menu_generate1($get_mid,$db,$cmsid)  
	{	
		...
		<?PHP
				...
				{
		?>
 			<div id="dyn-menu-pad"><a href="<?PHP echo SITE_URL."view-latest-openings.php";?>" class="dyn-menu">View latest Openings</a></div>
		<?PHP
				}
				if($get_mid == "4")
				{
		...
		?>
			<div id="dyn-menu-pad"><a href="<?PHP echo SITE_URL."view_talent.php";?>" class="dyn-menu">Talents</a></div>
			<div id="dyn-menu-pad"><a href="<?PHP echo SITE_URL.$pval; ?>" class="dyn-menu">Post a Job Ad</a></div>
		<?PHP
				}
				if($get_mid == "1")
				{?>
				<div id="dyn-menu-pad"><a href="<?PHP echo SITE_URL."view-intern.php";?>" class="dyn-menu">Intern Jobs</a></div>
		<?PHP	}
