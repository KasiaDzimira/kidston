  ...
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<strong>Dear</strong> <?PHP echo $fname; ?>, <br />
		Your friend <?PHP echo $uname; ?> has referred the following link
		<br />
   <center><span>[ <a href="<?PHP echo $linkjob; ?>" target="_blank"><?PHP echo $linkjob;?></a> ]</span></center>
                    <br />
                    Note: If the link is not working, please copy  paste the link to your address bar of your browser. <br />
                <br />
                  <span class="text"><strong>Regards,</strong><br />Team Kidston<br /></span></td>
        <td width="40" align="left" valign="top">&nbsp;</td>
