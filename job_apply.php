...
<title>Apply at KIDSTON &shy; application form</title> &shy;
...
<link href="<?PHP echo SITE_URL;?>calendar/calendar.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<?PHP echo SITE_URL;?>greybox/AJS.js"></script>
<script type="text/javascript" src="<?PHP echo SITE_URL;?>greybox/AJS_fx.js"></script>
<script type="text/javascript" src="<?PHP echo SITE_URL;?>greybox/gb_scripts.js"></script>
<link href="<?PHP echo SITE_URL;?>greybox/gb_styles.css" rel="stylesheet" type="text/css" media="all" />
</head>
<body>
<div id="inner-bg">
                      ...
                      <div class="home-tab-sec">
                        <div class="home-tab-r1">
                          <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="170" align="Left" valign="middle"><span class="tab-menu-sel">Apply for a Job</span></td>
                              <td width="1"></td>
                            </tr>
                          </table>
                        </div>
                              ...
                              <div class="tab-text-content">
                                <div class="inn-tab-text-cont-left-detail">
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                    <td>
                                      <div class="h1"><a href="<?PHP echo SITE_URL; ?>view-latest-openings.php">Jobs</a> &rsaquo;&rsaquo; <a href="<?PHP echo SITE_URL.'job/'.html_entity_decode($job_query['ID']).'/'.$db->stringToUrlSlug($job_query['job_title']); ?>"><?PHP echo "[". html_entity_decode($job_query['job_code']) ."]"; ?></a> &rsaquo;&rsaquo; Apply</div>
                                      <?PHP 
						if($job_query > 0)
						{ // if 
						?>
  ...
  <tr align="left" valign="top">
    <td height="25" class="smtxt"><strong>Email</strong><span class="star"> *</span></td>
                                          ...
                                          <tr align="left" valign="top">
                                            <td height="35" colspan="2" class="smtxt">
											<?php
                        ...
                        ?>
                                          ...
                                          <tr>
                                            <td align="left" valign="top" colspan="2" height="30">+<a href='javascript:void(0);' onClick="return_pg1('<?PHP echo $lval; ?>');"> Add more</a></td>
                                            <td >&nbsp;</td>
                                          </tr>
                                          
                                          <tr align="left" valign="top">
                                            <td height="35" colspan="2" class="bl-text"><strong>Attach application documents</strong> <span class="smtxt-g">[ DOC | DOCX | PDF | JPEG ] 
