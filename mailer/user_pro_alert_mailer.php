  ...
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="left" valign="top">Dear <?PHP echo $name;?> <br>
            <br>
            <p>Thanks for registering the email signup.</p>
            <p>Please click the link to activate the email signup.</p>
            <p>Link:&nbsp;<a href="<?PHP echo SITE_URL."subscribe.php?acc=".$user_id;?>">To Activate please click here</a></p>
            <p>Thanks,</p>
