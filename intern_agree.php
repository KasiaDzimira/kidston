			...
			<div class="inner-c2">
			  ...
			  <div class="apply-content-area">
			    ...
			    <div class="disc-bot">
				 ...
				 <form id="apply" name="apply" method="post" action="intern_apply.php">
				 		<input type="hidden" name="jid" id="jid" value="<?PHP echo $_REQUEST[jid]; ?>" />
						<input type="hidden" name="jagree" id="jagree" value="<?PHP echo base64_encode('YES'); ?>" />
					    <input name="agree" type="submit" id="agree" value="I agree" class="btn-common2"/>
				 
						<input name="disagree" type="button" id="disagree" value="I disagree" class="btn-common2" onclick="window.location.href='view-intern.php';" />		     						
				</form>	 
				</div>	
				</div>
			  </div>
