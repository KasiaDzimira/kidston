...
var siteurl = "https://www.kidston.ch/";
//var siteurl = "http://sundar/kidston/website_progressing/";
...
{//1
	msg = "";
		...
		{
			msg += "<br>- Please select the job area .";
		}
		...
		{
			msg += "<br>- Please enter the job type.";
		}
		if(msg != "")
		{
			prmt(msg);
...
function professional_alert_validate()
{//1
	msg = "";
		...
		{
			msg += "<br>- Please enter the company.";
		}
		if(document.getElementById("job_area").value == "")
		{
			msg += "<br>- Please select the job area .";
