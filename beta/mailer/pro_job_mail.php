  ...
  <tr>
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <p>
        Your KIDSTON Pro’s alert has new matches!<br>
        <br>
The following IT Specialists have been registrated in our database recently;
<br>
<br>
Link : <a href="<?PHP echo $link;?>" target="_blank"><?PHP echo $cdesign;?></a>
<br>
		    </p>
Best Regards,<br><br>
<strong>Your KIDSTON Team</strong><br><br>
 
<span class="small-text">You don’t like to receive new alerts? To unsubscribe please click <a href="<?PHP echo "http://www.kidston.ch/beta/unsubscribe.php?acc=".$user_id;?>" target="_blank">here</a>…</span><br>
