  ...
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="left" valign="top">Dear Admin,<br>
            <br>
            <p>There was a new Advertising Job Vacancies submission, ther details are as follows:</p>
            <p>&nbsp;</p>
               <p> Company Name: <?PHP echo $db->pinput("com_name");; ?></p>
               <p> Company Address: <?PHP echo $db->pinput("address1"); ?></p>
               <p> Country: <?PHP echo $db->pinput("countrySelect"); ?></p>
               <p> Name of Contact  Person: <?PHP echo $db->pinput("cont_pname"); ?></p>
               <p> Job Title of Contact  Person: <?PHP echo $db->pinput("cont_pdesign"); ?></p>
               <p> Email of Contact  Person: <?PHP echo $db->pinput("cont_pemail"); ?></p>
               <p> Telephone number of Contact  Person: <?PHP echo $db->pinput("cont_phone"); ?></p>
               <p> Remarks: <?PHP echo $db->pinput("remarks"); ?></p>
               <p>&nbsp;</p>
                <p>Thanks,</p>
                <p>Kidston Support Team</p>
                <p>&nbsp;</p></td>
          <td width="40" align="left" valign="top">&nbsp;</td>
