...
.small-text { font-family:Arial; font-size:10px; line-height:12px;}
  ...
  <tr>
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td align="left" valign="middle" height="30"><?PHP echo "Dear ".$name;?>,</td>
      ...
      <tr>
        ...
        <p>
        Your KIDSTON Job Alert has new matches!<br>
        <br>
The following jobs have been advertised on our homepage recently;
<br>
<br>
Link : <a href="<?PHP echo $link;?>" target="_blank"><?PHP echo $job_title;?></a>
<br>
		    </p>
Best Regards,<br><br>
<strong>Your KIDSTON Team</strong><br><br>
 
<span class="small-text">You don’t like to receive new job alerts? To unsubscribe please click <a href="<?PHP echo "http://www.kidston.ch/beta/unsubscribe.php?acc=".$user_id;?>" target="_blank">here</a>…</span><br>
 
This email has been generated automatically. Please do not respond to this message.
