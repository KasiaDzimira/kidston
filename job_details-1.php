...
<head>
    ...
    <meta name="description" content="KIDSTON vermittelt Top-Kandidaten an Top-Unternehmen im IT-Bereich und im kaufm�nnischen Sektor.">
    <meta name="description" content="KIDSTON introduces top candidates to top companies in the IT and commercial sectors.">
    <meta name="keywords" content="personalvermittlung it, it stellen, kaufm�nnische stellen, offene stellen.">
    ...
    {
        ?>
        <title>KIDSTON - Personalvermittlung f�r IT- und kaufm�nnische Stellen</title>
        <?PHP
    }
    if($_SESSION["slanguage"] == "2")
    {
        ...
        <div id="ind-page-section">
            <div id="ind-align">
                ...
                <div id="ind-banner-sec">
                    <div id="inner-banner">
                        <div id="ind-banner-logo"><a href="#"></a></div>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td style="padding-left: 15px;">
                                                                                                                ...
                                                                                                                if($_SESSION["slanguage"] == "1" || $_SESSION["slanguage"] == "")
                                                                                                                {
                                                                                                                    ...
                                                                                                                    {
                                                                                                                        $industry = "Konsum-/Luxusg�terindustrie";
                                                                                                                    }
                                                                                                                    if($inds == "Education")
                                                                                                                    {
                                                                                                                    ...
                                                                                                                    {
                                                                                                                        $industry = "�ffentl. Verwaltung/Verb�nde";
                                                                                                                    }
...
-->									  <?PHP
                                                                                                ...
                                                                                                <td height="45" align="left" valign="top">
                                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            {
                                                                                                                ?>
                                                                                                                <td height="30" align="left" valign="bottom" class="head-tab">Gew�nschtes Bewerberprofil</td>
                                                                                                                <?PHP
                                                                                                            }
                                                                                                            if($_SESSION["slanguage"] == "2")
                                                                                                            {
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            {
                                                                                                                ?>
                                                                                                                <td height="30" align="left" valign="bottom" class="smtxt"><strong>F�higkeiten : </strong> </td>
                                                                                                                <?PHP
                                                                                                            }
                                                                                                            if($_SESSION["slanguage"] == "2")
                                                                                                            {
                                                                                                    ...
                                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                        ...
                                                                                                        if($job_query['add_com'] != "")
                                                                                                        {
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                {
                                                                                                                    ?>
                                                                                                                    <td height="30" align="left" valign="bottom" class="head-tab"><strong>Zus�tzliche Bemerkungen : </strong></td>
                                                                                                                    <?PHP
                                                                                                                }
                                                                                                                if($_SESSION["slanguage"] == "2")
                                                                                                                {
                                                                        ...
                                                                        <div class="inn-tab-text-cont-right">
                                                                            ...
                                                                            $job_details_count = $db->fetchSingleRow("SELECT COUNT( ID ) as jcount FROM  `job_details` WHERE  `job_title` =  '".$job_title_count."'");
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <?PHP
                                                                                        $sql_sjob = "SELECT ID,job_title,job_type,location FROM  `job_details` WHERE  `job_title` =  '".$job_title_count."'";
                                                                                        ...
                                                                                        <div class="designation-pad">
                                                                                            ...
                                                                                            Negotiable |  Region Z�rich | Permanent </div>
                                                                                        <div class="designation-pad">
                                                                                        ...
                                                                                        <div class="designation-pad">
                                                                                            ...
                                                                                            Negotiable |  Region Z�rich | Permanent
                                                                                        </div>
