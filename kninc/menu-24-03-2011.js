//var ss="http://02af716.netsolhost.com/kidston/";
//var ss="http://saravanan/kidston/phase_1/";
var ss="http://www.kidston.ch/beta/";
var ddsmoothmenu={

//Specify full URL to down and right arrow images (23 is padding-right added to top level LIs with drop downs):
arrowimages: {down:['downarrowclass', ss+'knpic/blank.gif', ], right:['rightarrowclass', ss+'knpic/blank.gif']},
			...
			function(e){
				...
				if ($targetul.queue().length<=1){ //if 1 or less queued animations
					...
					if (smoothmenu.shadow.enabled){
						...
						this.$shadow.css({overflow:'hidden', width:this._dimensions.subulw+'px', left:shadowleft+'px', top:shadowtop+'px'}).animate({height:this._dimensions.subulh+'px'}, ddsmoothmenu.transition.overtime)
					}
				}
			},
			function(e){
